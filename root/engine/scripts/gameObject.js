...
function GameObject2(name, label) {
    this.name = name;
    this.label = label;
    this.active = true;
    ...
    this.trfmBase = new TransformData();
    this.trfmOffset = new TransformData();
    this.trfmGlobal = new TransformData();

    this.shapeData = new AAShapeData3D();
}
GameObject2.prototype = {
    AddChild: function(gameObject) {
        /// <signature>
        ///  <summary>Add a gameObject as a child of the caller</summary>
        ///  <param name="gameObject" type="GameObject">child GameObject to add</param>
    ...
    Update: function() {
        ...
        this.trfmGlobal.SetTransByVec(
            this.parent.trfmGlobal.trans.GetAdd(
                this.trfmBase.trans.GetAdd(
                    this.trfmOffset.rot.GetMultiplyVec3(this.trfmOffset.trans))));
